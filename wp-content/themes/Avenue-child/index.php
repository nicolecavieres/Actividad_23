...
<div class="cover">
	...
	<div class="proplist"><span>Locacion</span> <span class="propval"> <?php echo get_the_term_list( $post->ID, 'location', '', ' ', '' ); ?></span></div>
	...
	<div class="entry">
		...
		<a class="morer" href="<?php the_permalink() ?>">Mirar</a>
		<div class="clear"></div>
	</div>
</div>
</div>
